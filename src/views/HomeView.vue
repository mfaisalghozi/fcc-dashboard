...
const modules = [
  {
    ...
    description:
      "Automated parsing and AI-assisted analysis of Unusual Transaction Reports.",
  ...
  },
  {
    ...
    description:
      "Track batch submissions, review decisions, and manage STR approval workflow.",
  ...
  },
  {
    ...
    description:
      "Compose, review, and export Suspicious Transaction Reports for submission.",
...
<template>
  <div class="page">
    ...
    <footer class="footer">
      <span>FCC Automation · Internal Use Only</span>
...
:root {
  ...
  --rule: #dddbd6;
  --card-bg: #ffffff;
  --card-shadow: 0 1px 3px rgba(44, 44, 42, 0.07),
    0 4px 16px rgba(44, 44, 42, 0.06);
  --card-shadow-hover: 0 4px 8px rgba(44, 44, 42, 0.1),
    0 16px 40px rgba(44, 44, 42, 0.12);
  --radius: 14px;
}
...
.card {
  ...
  text-align: left;
  color: #2c2c2a;
  box-shadow: 0 1px 3px rgba(44, 44, 42, 0.07),
    0 4px 16px rgba(44, 44, 42, 0.06);
...
.card::before {
  ...
  transition: transform 280ms cubic-bezier(0.22, 0.68, 0, 1.2);
}

.card:hover {
  transform: translateY(-4px);
  box-shadow: 0 4px 8px rgba(44, 44, 42, 0.1),
    0 16px 40px rgba(44, 44, 42, 0.12);
  border-color: #c8c5be;
}
